...
public class patient_details_view extends javax.swing.JFrame {

    
    public patient_details_view() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Patient Details View & print Report");
        ...
        jButton2.setForeground(new java.awt.Color(30, 171, 245));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Details_id", "Patient_id", "patient name", "Date", "Category", "Entry Type"
            }
        ) {
        ...
        jLabel3.setText("Patient Details View & print Report");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new patient_details_view().setVisible(true);
            }
        });
    }
